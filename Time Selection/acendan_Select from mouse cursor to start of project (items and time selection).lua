...
-- @metapackage
-- @provides
--   [main] . > acendan_Select from mouse cursor to start of project (items and time selection).lua
...
function main()
  -- Get cursor info
  local ret, context, cur = reaper.BR_TrackAtMouseCursor()
  if ret and context == 2 then -- Cursor in arrange view
    -- Set time selection
