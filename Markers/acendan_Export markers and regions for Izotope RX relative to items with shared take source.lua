...
if reaper.JS_Dialog_BrowseForSaveFile then
  ...
  if num_sel_items > 0 then
    ...
    if archie_action then
      ...
      retval, file = reaper.JS_Dialog_BrowseForSaveFile( "Export Markers and Regions for RX", project_directory, "Markers and Regions - " .. parent_item_name .. ".txt", 'Text Files (.txt)\0*.csv\0All Files (*.*)\0*.*\0' )
