...
-- @metapackage
-- @provides
--   [main] . > acendan_Snap edit cursor to nearest razor edit edge in track under mouse.lua
...
function main()
  ...
  local track, _,_ = reaper.BR_TrackAtMouseCursor() -- Track under mouse
  if track then 
    ...
    if razor_edit ~= '' then
        ...
        local _, nearest_pos = NearestValue(positions, mouse_pos)
