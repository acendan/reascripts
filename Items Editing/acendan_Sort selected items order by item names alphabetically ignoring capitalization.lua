-- @description Sort Items Alphabetically Ignore Caps
-- @author Aaron Cendan
-- @version 1.0
-- @metapackage
-- @provides
--   [main] . > acendan_Sort selected items order by active take names alphabetically ignoring capitalization.lua
