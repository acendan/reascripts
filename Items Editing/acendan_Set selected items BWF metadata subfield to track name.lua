-- @description Set selected items BWF metadata subfield to track name
-- @author Aaron Cendan
-- @version 1.2
-- @metapackage
-- @provides
--   [main] . > acendan_Set selected items BWF metadata subfield to track name-sTAKE.lua
--   [main] . > acendan_Set selected items BWF metadata subfield to track name-sSCENE.lua
--   [main] . > acendan_Set selected items BWF metadata subfield to track name-sFILENAME.lua
--   [main] . > acendan_Set selected items BWF metadata subfield to track name-sTAPE.lua
--   [main] . > acendan_Set selected items BWF metadata subfield to track name-sNOTE.lua
